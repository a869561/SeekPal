        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-800 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-brand/50 focus:border-transparent text-sm transition"
            />
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2.5 rounded-xl bg-brand-soft text-brand hover:bg-brand/20 active:scale-[0.98] disabled:opacity-50 transition text-sm font-medium whitespace-nowrap"
              >
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 py-2.5 px-4 rounded-xl bg-brand hover:brightness-110 active:scale-[0.98] text-white font-medium text-sm disabled:opacity-50 transition"
            >
